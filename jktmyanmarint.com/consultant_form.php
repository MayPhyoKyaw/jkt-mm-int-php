      ...
      <div class="row">
        <div class="col-12 col-md-10 col-lg-9 mb-5 mt-4 mx-auto w-100">
          ...
          <form id="survey-form">
            ...
            <input type="text" id="name" placeholder="Enter Your Name" required class="appointment-input" /><br />

            <label for="email" id="email-label" class="appointment-label">Email </label><br />
            <input type="email" id="email" placeholder="Enter Your Email" class="appointment-input" required /><br />
            ...
            <fieldset class="appointment-fieldset">
              ...
              <input type="radio" id="appointment_type" name="appointment_type" value="Afternoon" />
            ...
            <textarea placeholder="Enter About Your Consultant" id="description" class="appointment-textarea" rows="4" cols="50" ></textarea>
